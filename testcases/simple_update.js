...
tests.push({
    ...
    ops: [
        {op: "update", query: {_id: {"#RAND_INT_PLUS_THREAD": [0, 100]}}, update: {$inc: {x: 1}}},
    ]
});

tests.push({
    name: "Update.AggIncNoIndex",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
        var docs = [];
    ...
    ops: [
        {
          ...
          command: {
              aggregate: "#B_COLL",
              pipeline: [
                  {$match: {_id: {"#RAND_INT_PLUS_THREAD": [0, 100]}}},
                  {$addFields: {x: {$add: ["$x", 1]}}},
                  {$save: 1}
              ],
              cursor: {}
...
var shortFieldNames = [
    ...
    "ab", "bb", "cb", "db", "ri", "si", "ti", "ui", "vi", "wi", "xi", "yi", "zi",
    "aj", "xm", "ym", "zm", "an", "bn", "cn", "dn", "en", "fn", "gn"
];
...
tests.push({
    ...
    ops: [{
        op: "update",
        query: {_id: {"#SEQ_INT": {seq_id: 0, start: 0, step: 1, mod: 100}}},
        update: {$inc: {aa: 1, da: 1, ha: 1, ma: 1, ta: 1}}
    }]
});

tests.push({
    name: "Update.AggIncFewSmallDoc",
    tags: ['update', 'core'],
    pre: function(collection) {
        collection.drop();
    ...
    ops: [
        {
          ...
          command: {
              aggregate: "#B_COLL",
              pipeline: [
                  {$match: {_id: {"#SEQ_INT": {seq_id: 0, start: 0, step: 1, mod: 100}}}},
                  {
                    $addFields: {
                        aa: {$add: ["$aa", 1]},
                        da: {$add: ["$da", 1]},
...
tests.push({
    ...
    ops: [{
        op: "update",
        query: {_id: {"#SEQ_INT": {seq_id: 0, start: 0, step: 1, mod: 100}}},
        update: {$inc: {aa: 1, wa: 1, xi: 1, zm: 1, gn: 1}}
    }]
});

tests.push({
    name: "Update.AggIncFewLargeDoc",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
...
*/
tests.push({
    name: "Update.IncFewSmallDocLongFields",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
        var docs = [];
...
tests.push({
    name: "Update.AggIncFewSmallDocLongFields",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
        var docs = [];
...
tests.push({
    name: "Update.AggIncFewLargeDocLongFields",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
...
*/
tests.push({
    name: "Update.SingleDocFieldAtOffset",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
...
tests.push({
    name: "Update.AggSingleDocFieldAtOffset",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
...
tests.push({
    ...
    ops: [
        {op: "update", multi: true, query: {}, update: {$set: {"a_256": "a"}}},
        {op: "update", multi: true, query: {}, update: {$set: {"a_256": "aa"}}}
    ]
});
tests.push({
    name: "Update.AggFieldAtOffset",
    tags: ['update', 'regression'],
    pre: function(collection) {
        collection.drop();
    ...
    ops: [
        {
          ...
          command: {
              aggregate: "#B_COLL",
              pipeline: [{$addFields: {"a_256": "a"}}, {$save: 1}],
              cursor: {}
          }
        },
        {
          ...
          command: {
              aggregate: "#B_COLL",
              pipeline: [{$addFields: {"a_256": "aa"}}, {$save: 1}],
              cursor: {}
          }
        },
    ]
